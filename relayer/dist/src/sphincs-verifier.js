...
function forsPkFromSig(sig, msg, pkSeed, adrs) {
 ...
 */
export function verifySphincsSignature(signature, message, publicKey) {
    try {
 ...
 */
export async function getRegisteredPublicKey(contractId, stellarAddress, sorobanServer) {
    try {
